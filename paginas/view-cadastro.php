	...
	<div class="bg-contact100" style="background-image: url('images/bg-01.jpg');">
		<div class="container-contact100">
			<div class="wrap-contact100">
				...
				<form class="contact100-form validate-form" method="POST" action="cadastro/cadastro.php" enctype="multipart/form-data">
					<span class="contact100-form-title">
						<span style="color: green;">Qr cadastrado com sucesso!</span>
					</span>
					...
					<div class="container-contact100-form-btn">
						<input type="button" class="contact100-form-btn" value="Voltar" onclick="novo_cadastro()">
					</div>
				...
				<div class="contact100-pic js-tilt" data-tilt>
					<!-- Imagem Qr -->
					<center class="espaco-categorias"><img src="../images/<?php echo $_SESSION['nome_arquivo']; ?>" alt="IMG"></center>
